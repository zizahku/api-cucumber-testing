...
class updatePersonalDetailStep {
	...
	def userClickMyInfoMenu() {
		WebUI.click(findTestObject('Page_OrangeHRM/a_My Info'))
	}

	@And("User update personal detail information")
	def userUpdatePersonalInfo() {
		WebUI.setText(findTestObject('Page_OrangeHRM/input_Nickname_oxd-input oxd-input--focus'), 'Lets Testing')
	}
	
	@Then("Personal detail information updated successfully")
	def personalDetailUpdated() {
